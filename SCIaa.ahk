...
__Add(hParent, x := 0, y := 0, w := 750, h := 390, Style := 0x50000000, ExStyle := 0x80) {
...
/*
	...
	This is the default function which will be called when the WM_NOTIFY message has been received.
