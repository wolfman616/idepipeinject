...
EnterSizeMove(wParam="") {
	...
	if( r_Wpos.w ) {
		...
		if g_dlgframe
			guiControl,Move,% hTab,% "x3 y" 0 " w" r_Wpos.w-2 " h" r_Wpos.h-240
...
, evhWnd, ldr_hWnd, htb, TabSelected, Pipes, vcount, icon_array, ppidd, SYSGUI_TBbUTTSZ, g_dlgframe
